...
function getpinnacle2() {

    var options = {sportId: 4};
    ...
    var options = {sportId: 4, oddsFormat: "DECIMAL"};
            ...
            event.periods.forEach(function(period){
              if (period.moneyline !== undefined) {
                pinnOdds.push({
                  ...
                  'URL': 'https://beta.pinnacle.com/en/Sports/4/Leagues/' + league.id + '/Events/' + event.id
                });
              };
            });
          });
